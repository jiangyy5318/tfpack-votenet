...
${CC} -std=c++11 tf_sampling.cpp tf_sampling_g.cu.o -o tf_sampling_so.so -shared -fPIC -I${TF_INC} -I${NVCC_INC} -L${TF_LIB} -L${NVCC_LIB} -ltensorflow_framework -lcudart -O2 -D_GLIBCXX_USE_CXX11_ABI=0
